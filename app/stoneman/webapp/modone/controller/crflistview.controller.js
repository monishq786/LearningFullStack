    ...
    function (genericlistview, Constant) {
        ...
        return genericlistview.extend("modonecontroller.crflistview", {
            ...
            initialize: async function () {
                ...
                this.setListViewDisplayColumns(["cadReqNo", "reqType", "createdBy", "buyerName", "status", "edit"]);
                this.setListViewDataColumns(["CRFREQNO", "REQTYP", "USERNAME", "BUYERNAME", "CRFSTATUS", "Edit"]);

                this.setListViewFilterColumn("cadreqlvInpCrfBuyer", "BuyerName", "Cfl", "eq", "String", "BUYERNAME", "cflForBuyer");
